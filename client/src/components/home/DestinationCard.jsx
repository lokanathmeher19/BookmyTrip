...
const DestinationCard = ({ image, city, state, badgeText, imagePosition = 'object-center', imageFit = 'object-cover' }) => {
  return (
    <div className="group cursor-pointer w-full aspect-[3/4] bg-white rounded-[2rem] overflow-hidden relative shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-white/20">
      <div className="w-full h-full overflow-hidden relative">
        <img 
          ...
          className={`w-full h-full ${imageFit} group-hover:scale-110 transition-transform duration-700 ease-out ${imagePosition}`}
        />
